...
export const LANGUAGES = [
  ...
  { id: "curl-scripts", family: "scripting", variants: [], frameworks: ["HTTP request collections (.http/.rest)", "hurl"],
    detect: { manifests: [], exts: [".http", ".rest", ".hurl"], markers: [] },
    test: [{ framework: "hurl", cmd: "hurl --test *.hurl" }], lane: "code", platform: "cli", depth: "core" },
