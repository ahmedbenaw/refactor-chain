...
function classify(utterance, mode) {
  ...
  return {
    ...
    note: s.embedded
      ...
      : s.specKit
      ? "spec-kit project detected (.specify/): at the plan step you'll choose how the chain works with your specs — Integrate (spec stays the source of truth) or Adopt (the refactor itself becomes spec-driven)."
      : undefined,
  };
}
