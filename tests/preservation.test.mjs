...
t("command count = 69", cmds.size === 69, cmds.size);

// ---- skills: 56, each with a SKILL.md whose frontmatter name matches its dir ----
const skills = readdirSync(join(ROOT, "skills")).filter((d) => existsSync(join(ROOT, "skills", d, "SKILL.md")));
t("skill count = 56", skills.length === 56, skills.length);
...
for (const sub of ["detect", "init", "status", "checkpoint", "advance", "fail", "heal", "record-edit", "reset", "baseline", "doctor"])
