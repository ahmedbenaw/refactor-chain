...
- **`spec-kit`** (a `.specify/` directory): diagnose surfaces it; `refactor-plan-gate` then pauses for the Integrate-vs-Adopt decision checkpoint (`refactor-plan-gate/references/spec-kit-interop.md`).
