...
else out({ skill: "refactor-backend-05-controller", lane: "java", phase: "do-the-work", prerequisite: "refactor-backend-04-service", next: "refactor-backend-06-dependency-guard", behaviorPreserving: true, steps: STEPS });
