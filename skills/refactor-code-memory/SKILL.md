...
- "You are here: step 1 of 2 (find-and-fix, then a quick review gate). The comparison shows 500 extra `EventListener` objects that never got cleaned up after opening and closing the dialog 50 times. That's the leak."
